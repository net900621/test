 ...
 * 
 **************************************************************************/
///http://mobapi.meilishuo.com/2.0/profile/feed?access_token=40e9e3d129808d758a83fc19113fd51e&userid=121291833&type=all
...
class SnakeSharemainV4conf {
	...
	public function __construct($arrInitConf) {
		...
		$this->cart_list['suffix']       = '/2.0/share/main';
...
*/
		...
		//print_r($arrApis);echo "\n";
		//echo get_class($this);echo "\n";
